...
*/
VKDevice::VKDevice():logicalDevice(VK_NULL_HANDLE),
	             physicalDevice(VK_NULL_HANDLE),
                     commandPool(VK_NULL_HANDLE)
{}
VKDevice::VKDevice(VkPhysicalDevice physicalDevice):logicalDevice(VK_NULL_HANDLE),
                                                    physicalDevice(VK_NULL_HANDLE),
                                                    commandPool(VK_NULL_HANDLE)
{
    bind(physicalDevice);
...
void VKDevice::bind(VkPhysicalDevice physicalDevice) {
 ...
 */
VkResult VKDevice::createLogicalDevice(VkPhysicalDeviceFeatures enabledFeatures, std::vector<const char*> enabledExtensions, void* pNextChain, bool useSwapChain, VkQueueFlags requestedQueueTypes){			
    ...
    printf("vkCreateDevice Success :%p \n",logicalDevice);
 ...
 */
VkResult VKDevice::createBuffer(VkBufferUsageFlags usageFlags, VkMemoryPropertyFlags memoryPropertyFlags, VkDeviceSize size, VkBuffer *buffer, VkDeviceMemory *memory, void *data){
 ...
 * @return VK_SUCCESS if buffer handle and memory have been created and (optionally passed) data has been copied
 */
VkResult VKDevice::createBuffer(VkBufferUsageFlags usageFlags, VkMemoryPropertyFlags memoryPropertyFlags, VKBuffer *buffer, VkDeviceSize size, void *data){
 ...
 */
void VKDevice::copyBuffer(VKBuffer *src, VKBuffer *dst, VkQueue queue, VkBufferCopy *copyRegion){
