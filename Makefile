...
TARGET_HEADERS += $(foreach dir,$(PROJECT_DIRS),$(wildcard $(dir)/*.hpp))
...
# for : Codes from Vulkan Samples 
CCFLAGS += -DVK_USE_PLATFORM_WAYLAND_KHR
PPFLAGS += -DVK_USE_PLATFORM_WAYLAND_KHR
# for backend/kms/vulkan.h kmr_vk_phdev_create_info kmsfd
CCFLAGS += -DINCLUDE_KMS
PPFLAGS += -DINCLUDE_KMS
